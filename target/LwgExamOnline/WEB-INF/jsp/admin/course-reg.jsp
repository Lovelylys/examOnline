...
<form action="${ctx}/course/addCourse.action" method="post" name="myform" id="myform">
<div class="main">
...
<div class="btn ue-clear">
    ...
    <a href="${ctx}/course/toCoursePage.action" class="clear"">返回</a>
</div>
</body>
...
//注册
function addCourse(){
	document.myform.attributes["action"].value = "${ctx}/course/addCourse.action";
	$("form").submit();
}
