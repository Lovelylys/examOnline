...
<form action="${ctx}/grade/addGrade.action" method="post" name="myform" id="myform">
<div class="main">
...
<div class="btn ue-clear">
    ...
    <a href="${ctx}/grade/toGradePage.action" class="clear">返回</a>
</div>
</body>
...
//注册
function addGrade(){
	document.myform.attributes["action"].value = "${ctx}/grade/addGrade.action";
	$("form").submit();
}
