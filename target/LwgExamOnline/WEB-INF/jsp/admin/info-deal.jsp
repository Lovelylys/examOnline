	...
	$.ajax({
		...
		success: function (data){
			...
			for(dataList in data){
				...
				html += "<td class='operate'><a href='${ctx}/admin/failinfo.action?userId="+data[dataList].userId+"' class='del'>注销</a>&nbsp;";
				<%--html += "<a href='${ctx}/admin/passinfo.action?userId="+data[dataList].userId+"' class='del'>通过</a>&nbsp;";--%>
