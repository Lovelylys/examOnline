	...
	<div id="hd">
    	<div class="hd-wrap ue-clear">
            ...
            <div class="login-info ue-clear">
                <div class="welcome ue-clear"><span>欢迎您,</span><a href="javascript:;" class="user-name">${adminName }</a></div>
        	...
        	<div class="sidebar">
                ...
                <ul class="nav">
                    ...
                    <li class="agency">
						...
						<ul class="subnav">
                        	<li><a href="javascript:;" onclick="formSubmit('${ctx}/grade/toGradePage.action','mframe');this.blur();">年级管理</a></li>
                            <li><a href="javascript:;" onclick="formSubmit('${ctx}/course/toCoursePage.action','mframe');this.blur();">课程管理</a></li>
                            <li><a href="javascript:;" onclick="formSubmit('${ctx}/examClass/toClassPage.action','mframe');this.blur();">班级管理</a></li>
                        </ul>
					</li>
                </ul>
            </div>
