...
<div class="main">
    ...
    <div class="long-input select ue-clear">
    	...
    	<c:forEach items="${grade}" var="cs">
			<input name="grade" type="radio" value="${cs.gradeId}" checked="checked" onclick="getClass()"/>${cs.gradeName}
		</c:forEach>
    </div>

    <div class="short-input select ue-clear">
    	<label><span style="color:red">*</span>账号类型：</label>
    	<input name="userType" type="radio" value="0"  onclick="addClass()"/>学生
    	<input name="userType" type="radio" value="1" checked="checked" onclick="notClass()"/>老师
    	<input name="userType" type="radio" value="2" onclick="notClass()"/>管理员
    </div>
    <p class="short-input ue-clear">
...
function getClass()
{
    ...
    $.ajax({
        type: "post",
        url: "${ctx}/class/queryClassByGradeId.action",
