...
<body>
<div class="title"><h2>学生能力管理</h2></div>
<form action="${ctx}/answer/deletePaper.action" method="post" name="myform" id="myform">
	...
	<table border="1" cellspacing="1" id="myTable">
    	<thead>
        	<tr>
                ...
                <th class="operate">所在班级</th>
                <th class="process">联系电话</th>
                <th class="process">科目</th>
...
function queryByClassAndCourse()
{
	...
	$.ajax({
		url:"${ctx}/answer/queryPageInfoByClassAndCourse.action",
		type:"post",
...
function InitTable(page)
{
	...
	$.ajax({
		url:"${ctx}/answer/queryAnswerByClassAndCourse.action",
		type:"post",
		contentType:"application/json",
		dataType: "json",
		data:JSON.stringify(data0),
		success: function(data){
			...
			for(dataList in data){
				...
				html += "<td>"+data[dataList].student.telephone+"</td>";
				html += "<td>"+data[dataList].course.courseName+"</td>";
				html += "<td class='operate'><a href='${ctx}/answer/qryTestPointScoreByCourseAndStudent.action?studentId="+data[dataList].student.userId+"&courseId="+
