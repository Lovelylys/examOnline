...
<div align="center">没有账号？ <a href="${ctx}/user/toRegistPage.action" target="_self" title="学生注册">注册</a></div>
...
<script type="text/javascript">
    ...
    function login(){
        ...
        $.post("${ctx}/user/checkPwd.action", { userId:userId, userPwd:userPwd },function(data){
            if(data.errorNo != "0"){
