...
<div class="table-operate ue-clear">
    ...
    <a href="javascript:;" class="del" onclick="deletePaper()">删除</a>
	...
	$.ajax({
		...
		success: function(data){
			...
			for(dataList in data){
				...
				html += "<td class='operate'><a href='${ctx}/paper/deletePaper.action?paperId="+data[dataList].paperId+"' class='del'>删除</a>&nbsp;";
				html += "<a href='${ctx}/paper/qryPaper.action?paperId="+data[dataList].paperId+"' class='del'>查看</a>&nbsp;";
				html += "<a href='${ctx}/paper/toExamPlan.action?paperId="+data[dataList].paperId+"' class='del'>发布考试</a></td>";
				html += "</tr>";
			}
			html += "</tbody>";
			$("tbody [align=center]").remove();
